...
},getTop:function(){return this.getPosition().y;},getLeft:function(){return this.getPosition().x;}});Element.Events.domready={onAdd:function(E){if(Browser.loaded){return E.call(this);
...
}},String:{parse:$lambda(false),compute:$arguments(1),serve:$arguments(0)}});var Asset=new Hash({javascript:function(F,D){D=$extend({onload:$empty,document:document,check:$lambda(true)},D);
...
for(var B in F){var E=this.prepare(this.elements[D],B,F[B]);A[B]=E.from;G[B]=E.to;}}return arguments.callee.parent(H,I);}});